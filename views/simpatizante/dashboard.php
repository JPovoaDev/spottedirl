...
$page_title = 'Painel Simpatizante';
...
<a href="subcategories.php" class="btn">As minhas subcategorias</a>
<a href="upload.php" class="btn">Novo registo</a>
<a href="batch_upload.php" class="btn">Upload em lote</a>

<!-- os meus registos mostra todos os spots do utilizador, públicos e privados, com opções de editar e apagar -->
<a href="my_spots.php" class="btn">Os meus registos</a>
...
<?php else: ?>
    ...
    <div class="spot-card">
        ...
        ?>
        <?php if ($spot['user_id'] !== $_SESSION['user_id']): ?>
        <form method="POST" action="../../controllers/follow_action.php" style="display:inline; margin-left: 10px;">
