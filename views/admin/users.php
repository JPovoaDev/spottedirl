...
$stmt = $pdo->prepare(
    "SELECT id, username, email, role, profile_visibility, is_active, is_verified, created_at
     FROM users
     WHERE id != ?
            ...
            <?php foreach ($reqs as $r): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="../../controllers/user_action.php"
                            ...
                            <button type="submit" class="btn btn-secondary"
                                style="background-color: #dc3545; border-color: #dc3545; color: white;">Rejeitar</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
        ...
        <tbody>
            ...
            <?php foreach ($users as $u): ?>
                <tr>
                    ...
                    <td style="color:<?= $u['is_verified'] ? 'green' : 'orange' ?>">
                        <?= $u['is_verified'] ? 'Sim' : 'Pendente' ?>
                    </td>
                    ...
                    <td>
                        ...
                        <?php if ($u['role'] === 'user'): ?>
                            <form method="POST" action="../../controllers/user_action.php"
                                ...
                                <button type="submit" class="btn btn-secondary">Promover a simpatizante</button>
                            </form>
                        ...
                        <?php elseif ($u['role'] === 'simpatizante'): ?>
                            <form method="POST" action="../../controllers/user_action.php"
                                ...
                                <input type="hidden" name="user_id" value="<?= $u['id'] ?>">
                                <button type="submit" class="btn btn-secondary">Remover simpatizante</button>
                            </form>
                        <?php endif; ?>
                        ...
                        <form method="POST" action="../../controllers/user_action.php"
                            ...
                            <input type="hidden" name="user_id" value="<?= $u['id'] ?>">
                            <button type="submit"
                                class="btn btn-secondary"><?= $u['is_active'] ? 'Suspender' : 'Reativar' ?></button>
                        </form>
